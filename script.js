...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Halooo Pacarku", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  title: 'Seberapa sayangnya emang kamu sama aku?',
                  icon: 'question',
                  input: 'range',
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${nama} kangen nda sama ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen banget sama ${nama} :((`).then(function () {
              ...
              Swal.fire(`Yakin ayaangg nda suka sama ${sender}?`, '', 'error').then(function () {
                Swal.fire('Yaudah lah bye!')
              })
            }
          })
